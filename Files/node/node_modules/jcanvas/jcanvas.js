...
function scaleIt(source, scaleFactor){
  ...
  var newHeight = source.height*scaleFactor;
  var newWidth = source.width*scaleFactor;

  var $statCanvas2 = $('<canvas height=' + newHeight + 'px width=' + newWidth + 'px" />');

  $statCanvas2[0].width = newWidth;
  $statCanvas2[0].height = newHeight;

  //console.log(source);
   $statCanvas2.drawImage({
            source: source,
            x: 0 ,
            y: 0,
            width: newWidth,
   ...
   img.src = $statCanvas2.getCanvasImage('png');
   return img;
}
